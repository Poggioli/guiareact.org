...
metaDescription: A razão de um guia de padrões React em Português.
---
...
não saber um idioma estrangeiro, como o inglês que é o idioma que mais encontramos 
conteúdos sobre tecnologia, sendo assim não conseguem encontrar nenhum ou poucos conteúdos 
de qualidade em **Português**.

Pensando nessa dor de muitas pessoas que tem o **Português** como idioma principal, 
